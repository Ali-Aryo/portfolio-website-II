...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    console.log("LiquidEther: mountRef element:", mountRef.current, mountRef.current.getBoundingClientRect());
...
`;
    ...
    class WebGLManager {
      ...
      init() {
        console.log("LiquidEther: prepending canvas, size:", Common.renderer.domElement.width, Common.renderer.domElement.height, "Common width/height:", Common.width, Common.height);
    ...
    const io = new IntersectionObserver(
      entries => {
        ...
        console.log("LiquidEther: IntersectionObserver callback - entry.isIntersecting:", entry.isIntersecting, "entry.intersectionRatio:", entry.intersectionRatio, "isVisible:", isVisible);
